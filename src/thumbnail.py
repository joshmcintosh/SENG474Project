...
EMPTY_THUMBNAIL = np.load(
    "../data/empty_thumbnail.npy"
)  # the thumbnail that is shown when a video has been deleted/removed


def get_thumbnails(video_ids, quality="default"):
    thumbnails = []
    missing = []
    count = 0
